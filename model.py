...
def train_classifier(X_train, y_train, scoring):
    ...
    weight_dicts = [{1:1, -1:1}, {1:5, -1:1}, {1:1, -1:5}, {1:10, -1:1}, {1:1, -1:10}, {1:20, -1:1}, {1:1, -1:20}]
    ...
    clf = GridSearchCV(svm.SVC(C=1,), param_grid, cv=5, scoring=scoring)
    print
...
def main():
    ...
    joblib.dump(clf, 'SVC_' + scoring + '.pkl')
